...
partial_patterns = patterns('',
                            ...
                            url(r'^result-element\.html$',
                                PartialGroupView.as_view(template_name='result-element.html'),
                                name='result-element.html'),
                            url(r'^results\.html$', PartialGroupView.as_view(template_name='results.html'),
                                name='results.html'),
                            url(r'^map-directive\.html$', PartialGroupView.as_view(template_name='map-directive.html'),
                                name='map-directive.html'),
                            url(r'^fonacide\.html$', PartialGroupView.as_view(template_name='fonacide.html'),
                                name='fonacide.html'),
                            url(r'^graficos\.html$', PartialGroupView.as_view(template_name='graficos.html'),
                                name='graficos.html'),
                            url(r'^resumen\.html$', PartialGroupView.as_view(template_name='resumen.html'),
                                name='resumen.html'),
                            url(r'^login\.html$', PartialGroupView.as_view(template_name='login.html'),
                                name='login.html'),
                            url(r'^denuncia\.html$', PartialGroupView.as_view(template_name='denuncia.html'),
                                name='denuncia.html'),
                            url(r'^archivos-contraloria\.html$',
                                PartialGroupView.as_view(template_name='archivos-contraloria.html'),
                                name='archivos-contraloria.html'),
                            url(r'^api\.html$', PartialGroupView.as_view(template_name='api.html'), name='api.html'),
                            url(r'^institucion-list\.html$',
                                PartialGroupView.as_view(template_name='institucion-list.html'),
                                name='institucion-list.html'),
                            url(r'^home\.html$', PartialGroupView.as_view(template_name='home.html'), name='home.html'),
                            url(r'^search\.html$', PartialGroupView.as_view(template_name='search.html'),
                                name='search.html'),
                            url(r'^nav\.html$', PartialGroupView.as_view(template_name='nav.html'), name='nav.html'),
                            url(r'^visualizaciones\.html$',
                                PartialGroupView.as_view(template_name='visualizaciones.html'),
                                name='visualizaciones.html'),
...
urlpatterns = patterns('',
                       ...
                       url(r'^((?!admin).)*/?prioridades/(?P<codigo_establecimiento>\w*)/?',
                           PrioridadController.as_view(), name='prioridad'),
                       url(r'^comentarios/(?P<codigo_establecimiento>\w+)/?', ComentariosController.as_view(),
                           name='comentarios'),
                       url(r'^((?!admin).)*/?establecimiento/(?P<codigo_establecimiento>\w*)/?$',
                           EstablecimientoController.as_view(), name='establecimiento'),
                       url(r'^((?!admin).)*/?institucion/(?P<codigo_establecimiento>\w*)/?$',
                           InstitucionController.as_view(), name='institucion'),
